...
|https://nvd.nist.gov/vuln/detail/CVE-2025-1534[CVE-2025-1534] |  | FIXED | Improper Neutralization of Input During Web Page Generation (XSS or 'Cross-site Scripting') vulnerability in Payara Platform Payara Server (REST Management Interface module) allows Remote Code Inclusion. | 4.1.2.191.53 | Payload Injection Attack via Management REST interface
