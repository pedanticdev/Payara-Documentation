...
== Payara Server 6.2024.10 (Web Profile) Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2024.10 (Web Profile)]
|===
...
+
https://docs.payara.fish/community/docs/6.2024.10/Jakarta%20EE%20Certification/6.2024.10/6.2024.10%20Web%20TCK%20Results.html[6.2024.10 Web TCK Results]
...
```
   [runcts] OUT => [javatest.batch] Completed running 737 tests.
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 737
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 0
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
```
