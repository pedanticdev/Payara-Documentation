...
== Payara Server 6.2024.9 (Web Profile) Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2024.9 (Web Profile)]
|===
...
+
https://docs.payara.fish/community/docs/6.2024.9/Jakarta%20EE%20Certification/6.2024.9/6.2024.9%20Web%20TCK%20Results.html[6.2024.9 Web TCK Results]
