...
== Payara Server 6.2025.2 (Web Profile) Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2025.2 (Web Profile)]
|===
...
+
https://docs.payara.fish/community/docs/6.2025.2/Jakarta%20EE%20Certification/6.2025.2/6.2025.2%20Web%20TCK%20Results.html[6.2025.2 Web TCK Results]
...
** Jakarta Faces 4.0.3 TCK
+
See test results in section `jsf`. +
Download URL & SHA-256:
https://download.eclipse.org/jakartaee/faces/4.0/jakarta-faces-tck-4.0.3.zip[jakarta-faces-tck-4.0.3.zip],
...
```
    ...
    [INFO]  [mvn.test] [INFO]
    [INFO]  [mvn.test] [INFO] Tests run: 1703, Failures: 0, Errors: 0, Skipped: 0
```
