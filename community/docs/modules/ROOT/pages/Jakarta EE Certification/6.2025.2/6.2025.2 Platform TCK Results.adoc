...
== Payara Server 6.2025.2 Jakarta EE 10 Platform Certification Summary
...
+
https://docs.payara.fish/community/docs/6.2025.2/Jakarta%20EE%20Certification/6.2025.2/6.2025.2%20Platform%20TCK%20Results.html[6.2025.2 Platform TCK Results]
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.056 sec
```
