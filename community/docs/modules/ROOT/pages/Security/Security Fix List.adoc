...
|https://nvd.nist.gov/vuln/detail/CVE-2023-0833[CVE-2024-8097] | 6.7 | FIXED | When the `org.glassfish.admingui` logger is set to the FINEST level, sensitive information can be exposed in log files. | 6.2024.9 | https://github.com/payara/Payara/pull/6906[#6906] |
