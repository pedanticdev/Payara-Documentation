...
The following distributions of Payara 6.2024.7 are certified, with results for each listed below:

* xref:Eclipse MicroProfile Certification/6.2024.7/Server TCK Results.adoc[Payara Server 6.2024.7]
* xref:Eclipse MicroProfile Certification/6.2024.7/Server Web TCK Results.adoc[Payara Server 6.2024.7 - Web profile]
