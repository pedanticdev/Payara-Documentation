...
The following distributions of Payara 6.2025.2 are certified, with results for each listed below:

* xref:Eclipse MicroProfile Certification/6.2025.2/Server TCK Results.adoc[Payara Server 6.2025.2]
* xref:Eclipse MicroProfile Certification/6.2025.2/Server Web TCK Results.adoc[Payara Server 6.2025.2 - Web profile]
