...
The following distributions of Payara 6.2025.1 are certified, with results for each listed below:

* xref:Eclipse MicroProfile Certification/6.2025.1/Server TCK Results.adoc[Payara Server 6.2025.1]
* xref:Eclipse MicroProfile Certification/6.2025.1/Server Web TCK Results.adoc[Payara Server 6.2025.1 - Web profile]
