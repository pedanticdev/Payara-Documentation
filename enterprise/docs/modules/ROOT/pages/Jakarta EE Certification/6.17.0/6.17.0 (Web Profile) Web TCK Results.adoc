...
== Payara Server (Web Profile) 6.17.0 Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 6.17.0 (Web Profile)]
|===
...
+
https://docs.payara.fish/enterprise/docs/6.17.0/Jakarta%20EE%20Certification/6.17.0/6.17.0%20Web%20TCK%20Results.html[6.17.0 Web TCK Results]
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.068 sec
```
