...
== Payara Server (Web Profile) 6.16.0 Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 6.16.0 (Web Profile)]
|===
...
+
https://docs.payara.fish/enterprise/docs/6.16.0/Jakarta%20EE%20Certification/6.16.0/6.16.0%20Web%20TCK%20Results.html[6.16.0 Web TCK Results]
...
```
   [mvn.test] Results :
   [mvn.test]
   [mvn.test] Tests run: 1046, Failures: 0, Errors: 0, Skipped: 0
```
...
```
    ...
    [INFO]  [mvn.test] [INFO]
    [INFO]  [mvn.test] [INFO] Tests run: 1698, Failures: 0, Errors: 0, Skipped: 0
```
