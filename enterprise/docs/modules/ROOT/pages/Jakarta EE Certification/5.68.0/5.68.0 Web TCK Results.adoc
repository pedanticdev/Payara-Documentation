...
**Payara Server 5.68.0 Web Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.68.0 (Web Profile)]
|===
...
+
https://docs.payara.fish/enterprise/docs/Jakarta%20EE%20Certification/5.68.0/5.68.0%20Web%20TCK%20Results.html
...
```
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.054 sec
```
