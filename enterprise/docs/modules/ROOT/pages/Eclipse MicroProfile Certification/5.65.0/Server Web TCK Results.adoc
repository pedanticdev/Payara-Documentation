...
**Payara Server 5.65.0 Web Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.65.0 (Web Profile)]
|===
...
+
https://docs.payara.fish/enterprise/docs/Eclipse%20MicroProfile%20Certification/5.65.0/Server%20Web%20TCK%20Results.html
