...
|https://nvd.nist.gov/vuln/detail/CVE-2023-4043[CVE-2024-8097] | 6.7 | FIXED | When the `org.glassfish.admingui` logger is set to the FINEST level, sensitive information can be exposed in log files.  | 6.18.0 |
